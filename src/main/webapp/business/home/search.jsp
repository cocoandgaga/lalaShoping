...
<head>
    ...
    <link href="${pageContext.request.contextPath}/business/css/seastyle.css" rel="stylesheet" type="text/css" />

    <script type="text/javascript" src="${pageContext.request.contextPath}/business/basic/js/jquery-1.7.min.js"></script>
    <script type="text/javascript" src="${pageContext.request.contextPath}/business/js/script.js"></script>
</head>
                ...
                <div class="search-side">
                    ...
                    <li>
                        <div class="i-pic check">
                            <img src="${pageContext.request.contextPath}/business/images/cp.jpg" />
                    ...
                    <li>
                        <div class="i-pic check">
                            <img src="${pageContext.request.contextPath}/business/images/cp2.jpg" />
        ...
        <div id="wrap">
            ...
            <div class="quick_toggle">
                ...
                <li class="qtitem">
                    ...
                    <div class="mp_qrcode" style="display:none;"><img src="${pageContext.request.contextPath}/business/images/weixin_code_145.png" /><i class="icon_arrow_white"></i></div>
                </li>
                <li class="qtitem">
