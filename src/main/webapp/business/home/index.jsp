...
<head>
    ...
    <link href="${pageContext.request.contextPath}/business/css/hmstyle.css" rel="stylesheet" type="text/css"/>
    ...
    <div class="slideall" style="height: auto;">
        ...
        <div class="bannerTwo">
            ...
            <div class="am-slider am-slider-default scoll" data-am-flexslider id="demo-slider-0">
                <ul class="am-slides">
                    <li class="banner1"><a href="introduction.html"><img src="${pageContext.request.contextPath}/business/images/ad5.jpg"/></a></li>
                    <li class="banner2"><a><img src="${pageContext.request.contextPath}/business/images/ad6.jpg"/></a></li>
                    <li class="banner3"><a><img src="${pageContext.request.contextPath}/business/images/ad7.jpg"/></a></li>
                    <li class="banner4"><a><img src="${pageContext.request.contextPath}/business/images/ad8.jpg"/></a></li>
                </ul>
            </div>
            <div class="clear"></div>
        </div>
                        ...
                        <ul class="category-list navTwo" id="js_climit_li">
                            <li>
                                <div class="category-info">
                                    <h3 class="category-name b-category-name"><i><img src="${pageContext.request.contextPath}/business/images/cake.png"></i><a
                            ...
                            <li>
                                <div class="category-info">
                                    <h3 class="category-name b-category-name"><i><img src="${pageContext.request.contextPath}/business/images/cookies.png"></i><a
                            ...
                            <li>
                                <div class="category-info">
                                    <h3 class="category-name b-category-name"><i><img src="${pageContext.request.contextPath}/business/images/meat.png"></i><a
                            ...
                            <li>
                                <div class="category-info">
                                    <h3 class="category-name b-category-name"><i><img src="${pageContext.request.contextPath}/business/images/bamboo.png"></i><a
                            ...
                            <li>
                                <div class="category-info">
                                    <h3 class="category-name b-category-name"><i><img src="${pageContext.request.contextPath}/business/images/nut.png"></i><a
                            ...
                            <li>
                                <div class="category-info">
                                    <h3 class="category-name b-category-name"><i><img src="${pageContext.request.contextPath}/business/images/candy.png"></i><a
                            ...
                            <li>
                                <div class="category-info">
                                    <h3 class="category-name b-category-name"><i><img src="${pageContext.request.contextPath}/business/images/chocolate.png"></i><a
                            ...
                            <li>
                                <div class="category-info">
                                    <h3 class="category-name b-category-name"><i><img src="${pageContext.request.contextPath}/business/images/fish.png"></i><a
                            ...
                            <li>
                                <div class="category-info">
                                    <h3 class="category-name b-category-name"><i><img src="${pageContext.request.contextPath}/business/images/tea.png"></i><a
                            ...
                            <li>
                                <div class="category-info">
                                    <h3 class="category-name b-category-name"><i><img src="${pageContext.request.contextPath}/business/images/package.png"></i><a
        ...
        <div class="am-g am-g-fixed smallnav">
            <div class="am-u-sm-3">
                <a href="sort.html"><img src="${pageContext.request.contextPath}/business/images/navsmall.jpg"/>
                    <div class="title">商品分类</div>
                </a>
            </div>
            <div class="am-u-sm-3">
                <a href="#"><img src="${pageContext.request.contextPath}/business/images/huismall.jpg"/>
                    <div class="title">大聚惠</div>
                </a>
            </div>
            <div class="am-u-sm-3">
                <a href="#"><img src="${pageContext.request.contextPath}/business/images/mansmall.jpg"/>
                    <div class="title">个人中心</div>
                </a>
            </div>
            <div class="am-u-sm-3">
                <a href="#"><img src="${pageContext.request.contextPath}/business/images/moneysmall.jpg"/>
        ...
        <!--各类活动-->
        <div class="row">
            <li><a><img src="${pageContext.request.contextPath}/business/images/row1.jpg"/></a></li>
            <li><a><img src="${pageContext.request.contextPath}/business/images/row2.jpg"/></a></li>
            <li><a><img src="${pageContext.request.contextPath}/business/images/row3.jpg"/></a></li>
            <li><a><img src="${pageContext.request.contextPath}/business/images/row4.jpg"/></a></li>
        </div>
        <div class="clear"></div>
        <!--走马灯 -->
            ...
            <div class="demo">
                ...
                <ul>
                    <li class="title-first"><a target="_blank" href="#">
                        <img src="${pageContext.request.contextPath}/business/images/TJ2.jpg"></img>
                        <span>[特惠]</span>洋河年末大促，低至两件五折
                    </a></li>
                    <li class="title-first"><a target="_blank" href="#">
                        <span>[公告]</span>商城与广州市签署战略合作协议
                        <img src="${pageContext.request.contextPath}/business/images/TJ.jpg"></img>
        ...
        <div class="am-container">
            ...
            <div class="am-g am-g-fixed sale">
                <div class="am-u-sm-3 sale-item">
                    <div class="s-img">
                        <a href="# "><img src="${pageContext.request.contextPath}/business/images/sale3.jpg"/></a>
                    </div>
                    <div class="s-info">
                ...
                <div class="am-u-sm-3 sale-item">
                    <div class="s-img">
                        <a href="# "><img src="${pageContext.request.contextPath}/business/images/sale2.jpg"/></a>
                    </div>
                    <div class="s-info">
                        <a href="#"><p class="s-title">ZEK 原味海苔</p></a>
                        <div class="s-price">￥<b>9.90</b>
                ...
                <div class="am-u-sm-3 sale-item">
                    <div class="s-img">
                        <a href="# "><img src="${pageContext.request.contextPath}/business/images/sale1.jpg"/></a>
                    </div>
                    <div class="s-info">
                        <a href="#"><p class="s-title">ZEK 原味海苔</p></a>
                        <div class="s-price">￥<b>9.90</b>
        ...
        <div class="f1">
            ...
            <div class="am-g am-g-fixed floodSix ">
                <div class="am-u-sm-5 am-u-md-3 text-one list">
                    ...
                    <a href="# ">
                        <img src="${pageContext.request.contextPath}/business/images/5.jpg"/>
                        <div class="outer-con ">
                            <div class="title ">
                                零食大礼包开抢啦
                            </div>
                ...
                <div class="am-u-sm-7 am-u-md-5 am-u-lg-2 text-two big">
                    ...
                    <a href="# "><img src="${pageContext.request.contextPath}/business/images/act1.png"/></a>
                </div>
                ...
                <li>
                    <div class="am-u-md-2 am-u-lg-2 text-three">
                        ...
                        <a href="# "><img src="${pageContext.request.contextPath}/business/images/1.jpg "/></a>
                    </div>
                </li>
                <li>
                    <div class="am-u-md-2 am-u-lg-2 text-three sug">
                        ...
                        <a href="# "><img src="${pageContext.request.contextPath}/business/images/2.jpg "/></a>
                    </div>
                </li>
                <li>
                    <div class="am-u-sm-4 am-u-md-5 am-u-lg-4 text-five">
                        ...
                        <a href="# "><img src="${pageContext.request.contextPath}/business/images/5.jpg"/></a>
                    </div>
                </li>
                <li>
                    <div class="am-u-sm-4 am-u-md-2 am-u-lg-2 text-six">
                        ...
                        <a href="# "><img src="${pageContext.request.contextPath}/business/images/3.jpg"/></a>
                    </div>
                </li>
                <li>
                    <div class="am-u-sm-4 am-u-md-2 am-u-lg-4 text-six">
                        ...
                        <a href="# "><img src="${pageContext.request.contextPath}/business/images/4.jpg"/></a>
                    </div>
                </li>
            </div>
            ...
            <div class="am-g am-g-fixed floodSeven">
                <div class="am-u-sm-5 am-u-md-4 text-one list ">
                    ...
                    <a href="# ">
                        ...
                        <img src="${pageContext.request.contextPath}/business/images/11.jpg"/>
                    </a>
                    <div class="triangle-topright"></div>
                </div>
                ...
                <div class="am-u-sm-7 am-u-md-4 text-two big">
                    ...
                    <a href="# "><img src="${pageContext.request.contextPath}/business/images/act2.png "/></a>
                ...
                <li>
                    <div class="am-u-sm-7 am-u-md-4 text-two">
                        ...
                        <a href="# "><img src="${pageContext.request.contextPath}/business/images/6.jpg"/></a>
                    </div>
                </li>
                <li>
                    <div class="am-u-sm-3 am-u-md-2 text-three sug">
                        ...
                        <a href="# "><img src="${pageContext.request.contextPath}/business/images/7.jpg"/></a>
                    </div>
                </li>
                <li>
                    <div class="am-u-sm-3 am-u-md-2 text-three big">
                        ...
                        <a href="# "><img src="${pageContext.request.contextPath}/business/images/10.jpg"/></a>
                    </div>
                </li>
                <li>
                    <div class="am-u-sm-3 am-u-md-2 text-three ">
                        ...
                        <a href="# "><img src="${pageContext.request.contextPath}/business/images/8.jpg"/></a>
                    </div>
                </li>
                <li>
                    <div class="am-u-sm-3 am-u-md-2 text-three ">
                        ...
                        <a href="# "><img src="${pageContext.request.contextPath}/business/images/9.jpg"/></a>
                    </div>
                </li>
            </div>
            <div class="clear "></div>
    ...
    <div id="sidebar">
        <div id="wrap">
            <div id="prof" class="item ">
                ...
                <div class="ibar_login_box status_login ">
                    <div class="avatar_box ">
                        <p class="avatar_imgbox "><img src="${pageContext.request.contextPath}/business/images/no-img_mid_.jpg "/></p>
                        <ul class="user_info ">
                            <li>用户名：sl1903</li>
                            <li>级&nbsp;别：普通会员</li>
                        </ul>
            ...
            <div id="brand " class="item ">
                <a href="#">
                    <span class="wdsc "><img src="${pageContext.request.contextPath}/business/images/wdsc.png "/></span>
                </a>
                <div class="mp_tooltip ">
                    我的收藏
                    <i class="icon_arrow_right_black "></i>
            ...
            <div id="broadcast " class="item ">
                <a href="# ">
                    <span class="chongzhi "><img src="${pageContext.request.contextPath}/business/images/chongzhi.png "/></span>
                </a>
                <div class="mp_tooltip ">
                    我要充值
                    <i class="icon_arrow_right_black "></i>
            ...
            <div class="quick_toggle ">
                ...
                <li class="qtitem ">
                    ...
                    <div class="mp_qrcode " style="display:none; "><img src="${pageContext.request.contextPath}/business/images/weixin_code_145.png "/><i
...
<script type="text/javascript " src="${pageContext.request.contextPath}/business/basic/js/quick_links.js "></script>
<script>
    $(function(){
